...
// // Here, we are accessing data attribute attached to 'map' in html which we did in 'tour.pug'. As it is a string we are converting it back to object using JSON.parse
